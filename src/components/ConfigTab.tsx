...
import { CONFIG_QUERY_KEY, UPSTREAM_STATUS_QUERY_KEY, useAppConfig } from "../lib/queries";
...
export function ConfigTab() {
  ...
  async function saveConfig() {
    ...
    try {
      ...
      void queryClient.invalidateQueries({ queryKey: UPSTREAM_STATUS_QUERY_KEY });
  ...
  async function testConfig() {
    ...
    try {
      ...
      // A successful test means the upstream just became reachable; refresh the shared status that
      // drives both the sidebar and Chat model selector.
      void queryClient.invalidateQueries({ queryKey: UPSTREAM_STATUS_QUERY_KEY });
